...
export const connectString = "(description= (retry_count=20)(retry_delay=3)(address=(protocol=tcps)(port=1521)(host=adb.eu-zurich-1.oraclecloud.com))(connect_data=(service_name=???_quiz_high.adb.oraclecloud.com))(security=(ssl_server_dn_match=yes)))"
